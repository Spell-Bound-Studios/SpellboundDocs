...
SimpleVolume a default implementation of a GeoForge [volume.md](../../../terminology/volume.md "mention"). It can be used to represent things such as a hunk of destructible rock, an ice sculpture, or a large but finite Terrain. GeoForge supports infinite terrains, but Simple Volume is not the correct class for it.\
\
