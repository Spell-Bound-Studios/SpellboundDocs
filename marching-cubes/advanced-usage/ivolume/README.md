...
\
IVolume methods and properties belong to two different categories. Abstract that must be implemented in the concrete class, and with Default Implementations which can be overridden or extended but does not need to be.&#x20;
